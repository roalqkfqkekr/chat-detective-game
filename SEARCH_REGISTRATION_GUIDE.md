...
`https://roalqkfqkekr.github.io/chat-detective-game/`

sitemap 확인:

`https://roalqkfqkekr.github.io/chat-detective-game/sitemap.xml`

robots 확인:

`https://roalqkfqkekr.github.io/chat-detective-game/robots.txt`
...
9. 배포 후 아래 주소로 인증 파일 접속을 확인합니다.
   ...
   `https://roalqkfqkekr.github.io/chat-detective-game/googlexxxx.html`
...
```text
site:roalqkfqkekr.github.io/chat-detective-game
```
